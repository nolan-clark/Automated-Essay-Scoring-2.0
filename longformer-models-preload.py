...
training_args = TrainingArguments(
    output_dir='/kaggle/input/longformer-models-preload/',
...
model.save_pretrained('/kaggle/input/longformer-models-preload/model')
tokenizer.save_pretrained('/kaggle/input/longformer-models-preload/token')
